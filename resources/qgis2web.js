...
var initialExtent_NEWTPMMonitoringList_2 = [4808611.987528, 1357749.831124, 5071165.300326, 1599727.773935];

function fitInitialExtent() {
    map.updateSize();
    map.getView().fit(initialExtent_NEWTPMMonitoringList_2, { size: map.getSize() });
}

// Sofort versuchen (falls die Größe schon stimmt)
fitInitialExtent();

// Erneut versuchen, sobald die Seite (inkl. iFrame-Layout in SharePoint) vollständig geladen ist
window.addEventListener('load', function() {
    setTimeout(fitInitialExtent, 200);
});

// Automatisch neu ausrichten, falls sich die iFrame-/Containergröße nachträglich ändert
